...
package test.builder.service.persistence.impl.constants;
...
public class DUMMYPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "test.builder.service";
